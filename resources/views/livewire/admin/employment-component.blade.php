<div class="container-fluid">
    ...
    @include('livewire.admin.employment-component.'.$frame)
</div> <!-- container -->
...
{{--    <script src="{{ asset('assets/admin/libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js') }}"></script>--}}
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            window.livewire.on('refreshRangeFlatpickr', () => {
                activeRangeFlatpickr('.range-schedule');
            });
            ...
            window.livewire.on('refreshComponent', () => {
                ...
                activeSelect2('#category_employment', 'category_employment');
            });
        ...
        function activeRangeFlatpickr(sel, is_time = 0) {
            $(sel).flatpickr({
                mode: "range",
                enableTime: !!is_time,
                dateFormat: `${is_time ? 'Y-m-d H:i' : 'Y-m-d'}`,
