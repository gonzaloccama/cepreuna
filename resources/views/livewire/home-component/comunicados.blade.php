...
<div class="project-area pt-10 pb-10">
    @php
        $statements = \App\Models\Statement::orderBy('created_at', 'desc')->paginate($statementLoadMore);
                            ...
                            <div class="user-content">
                                <a href="javascript:;" class="text-center">
                                    <h5 class="text-primary font-size-25 mb-0"
                                        style="font-weight: 500">{{ __('¡Aun no existe comunicados!') }}</h5>
                                    <div
                                        class="user-occupation">{{ __('Cuando tengamos comunicados se pubicaran aqui...') }}</div>
                                </a>
                            </div>
                        </div>
                    @endif
