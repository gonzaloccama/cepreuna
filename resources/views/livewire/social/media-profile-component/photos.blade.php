            ...
            <div class="iq-card-body p-0">
                <div class="row">
                    ...
                    $photos = \App\Models\MediaPostsPhoto::orderBy('created_at', 'desc')
                        ...
                        ->where('media_posts.post_type', '!=', 'profile_picture')
                        ->where('media_posts.post_type', '!=', 'profile_cover')
                ...
                <div class="row">
                    ...
                    $photos = \App\Models\MediaPostsPhoto::orderBy('created_at', 'desc')
                        ->where(function ($query) {
                            $query->orWhere('media_posts.post_type', 'profile_picture');
                            $query->orWhere('media_posts.post_type', 'profile_cover');
                        })
                        ->where('media_posts.user_id', $user->id)
                        ->join('media_posts', 'media_posts_photos.post_id', '=', "media_posts.id")
                        ->select('media_posts_photos.*')
