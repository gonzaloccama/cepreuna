<div class="tab-pane fade {{ $tab_pane == 'personal-information'?'active show':'' }}"
    ...
    <?php
    $img = $user_gender == 2 ? 'woman.png' : 'man.png';
...
{{--                            <div class="p-image">--}}
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control @error('user_dni') is-invalid @enderror"
                                   placeholder="DNI"
                                   aria-label="DNI" aria-describedby="button-addon2" readonly
                ...
                $provinces = [];
                if ($user_region) {
                    $provinces = json_decode(\App\Models\Region::find($user_region)->province);
                }
                ?>
