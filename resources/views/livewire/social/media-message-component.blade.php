                        ...
                        <div class="row" wire:poll="mountData">
                                ...
                                <div class="chat-search pt-3 pl-3">
                                    ...
                                    <div id="user-detail-popup" class="overflow-auto w-100">
                                        <div class="user-profile">
                                            ...
                                            <hr>
                                            <div class="user-detail text-left mt-4 pl-4 pr-4" wire:ignore.self>
                                                ...
                                                <ul class="user-status p-0">
                                                    ...
                                                    <li class="mb-1"><i
                                                            class="ri-checkbox-blank-circle-fill text-danger pr-1"></i><span>Do Not Disturb</span>
                                                    </li>
                                                    <li class="mb-1"><i
                            ...
                            <div class="col-lg-8 chat-data p-0 chat-data-right">
                                <div class="tab-content mt-0 pt-0">
                                    ...
                                    @include('livewire.social.media-messages-component.area-messages')
