        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title font-rajdhani uppercase weight-500" id="post-modalLabel">Crear Post</h4>
                    <button type="button"
                            class="btn btn-outline-danger rounded-pill mr-1 pr-1 ml-2 pl-2 mt-1 pt-1 pb-1 mb-1"
                            data-dismiss="modal"
                            wire:click.prevent="cleanItems"><i class="ri-close-circle-line"
                ...
                <div class="modal-body">
                    ...
                    @php
                        ...
                        if ($text) {
                            if (preg_match_all($pattern_url, $text, $out)) {
                                $findUrl = $out[0];
                            }
                            if ($findUrl) {
                    ...
                    <hr>
                    @if(!$photo_source && !$video_source && !$file_source && !$findUrl)
                        ...
                        <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                            ...
                            <li class="col-md-12 mb-1 text-center">
                                <div wire:loading wire:target="photo_source">
                                    <div class="alert alert-danger rounded-0 w-100" role="alert">
                                        <div class="spinner-grow" role="status"></div>
                                        <div class="iq-alert-text  pl-3">Cargando...</div>
                                    </div>
                                </div>
                                <div wire:loading wire:target="video_source">
                                    <div class="alert alert-danger rounded-0 w-100" role="alert">
                                        <div class="spinner-grow" role="status"></div>
                                        <div class="iq-alert-text  pl-3">Cargando...</div>
                                    </div>
                                </div>
                                <div wire:loading wire:target="file_source">
                                    <div class="alert alert-danger rounded-0 w-100" role="alert">
                                        <div class="spinner-grow" role="status"></div>
                                        <div class="iq-alert-text  pl-3">Cargando...</div>
                                    </div>
                    ...
                    @elseif($file_source)
                        ...
                        @endphp
                    @elseif($idUrl != '' && strlen($idUrl[0]) == 11)
                    ...
                    @elseif(str_contains($findUrl[0], 'https://drive.google.com/file/d/'))
                        <div class="col-md-12 mb-3 text-center">
                    ...
                    @enderror
                    @error('file_source')
                    <div class="text-danger col-md-12 text-errors mt-1 mb-3 font-italic">
                        {!! $message !!}
                    </div>
                    @enderror
