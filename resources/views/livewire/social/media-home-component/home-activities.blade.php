<div class="col-lg-4">
    ...
    <div class="iq-card">
        ...
        <div class="iq-card-body">
            <?php
            $events = App\Models\MediaEvent::orderBy('event_start_date', 'desc')
        ...
        <div class="iq-card-body">
            <ul class="media-story m-0 p-0">
                @foreach($birthdates as $birthdate)
                    <?php
                    $img = $birthdate->user_gender == 2 ? 'woman.png' : 'man.png';
                    ...
                    <li class="d-flex mb-4 align-items-center">
                        ...
                        <div class="stories-data ml-3">
                            <h5>
                                <a href="{{ route('social.profile', ['id' => base64_encode($birthdate->id)]) }}"
