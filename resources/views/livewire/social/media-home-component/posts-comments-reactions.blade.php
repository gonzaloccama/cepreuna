<div class="like-data">
    @php
        $myLike = \App\Models\MediaPostsCommentsReaction::where('comment_id', $comment->id)
            ->where('user_id', auth()->user()->id)
            ->first();
        $likes = \App\Models\MediaPostsCommentsReaction::where('comment_id', $comment->id)->get()->count();
    @endphp
